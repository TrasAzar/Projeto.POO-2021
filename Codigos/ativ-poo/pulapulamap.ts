...
class pulapula{
    ...
    in(kid: Kid){
        for( let entry of kid.entries()){
            console.log(entry[0]. entry [1]);
        }
        // let idade = new Map<number, string>();
        // if(this.brincando.has(esperando)){
        //     let existente = this.brincando.get(esperando);
        //     for(let brincando of esperando){
        //         existente.AddFone();
        //     }
        // }else{
        //     this.brincando.set(esperando);
        //     }
        // }
